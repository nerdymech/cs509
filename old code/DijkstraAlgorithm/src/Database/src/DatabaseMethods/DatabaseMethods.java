...
public class DatabaseMethods {
	...
	public ArrayList<Point> ReadPoints(){
		...
		try { 
            File csv = new File("/Users/Hongnan/Documents/Git/cs509_Git/DijkstraAlgorithm/src/Database/src/DatabaseMethods/Higgins.csv"); // CSV file address
	...
	public void SavePoint(Point point){
      ArrayList<Point> all_point= new ArrayList<>(this.ReadPoints());
		 try { 
	          ...
	          if (no_same_point) {
	        	  File csv = new File("/Users/Hongnan/Documents/Git/cs509_Git/DijkstraAlgorithm/src/Database/src/DatabaseMethods/Higgins.csv"); // CSV address
    ...
    public ArrayList<Building> ReadBuildings(){
    	...
    	try { 
            File csv = new File("/Users/Hongnan/Documents/Git/cs509_Git/DijkstraAlgorithm/src/Database/src/DatabaseMethods/Buildings.csv"); // CSV file address
    ...
    public void SaveBuilding(Building building){
    	...
    	try { 
    		 boolean no_same_building=true;
	          ...
	          if (no_same_building) {
	        	  File csv = new File("/Users/Hongnan/Documents/Git/cs509_Git/DijkstraAlgorithm/src/Database/src/DatabaseMethods/Buildings.csv"); // CSV address
    ...
    public ArrayList<Edge> ReadEdges(){
      ArrayList<Edge> edges= new ArrayList<>();
    	...
    	try { 
            File csv = new File("/Users/Hongnan/Documents/Git/cs509_Git/DijkstraAlgorithm/src/Database/src/DatabaseMethods/Edges.csv"); // CSV file address
    	...
    	try {          
    		boolean no_same_edge=true;
	          for(Edge e:all_edges){
	        	  if (e.getStartPointID()== edge.getStartPointID() && e.getEndPointID()==e.getEndPointID()) {
					no_same_edge=false;
				}
	          }
	          if (no_same_edge) {
	        	  File csv = new File("/Users/Hongnan/Documents/Git/cs509_Git/DijkstraAlgorithm/src/Database/src/DatabaseMethods/Edges.csv"); // CSV address
    ...
    public Point GetStartPoint(Edge edge){
    	...
    	System.out.println(point.getxCooridinate());
    	System.out.println(point.getyCooridinate());
    	return point;
    }
