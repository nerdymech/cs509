...
public class MapPanel extends JFrame{
	...
	//final Image img = Toolkit.getDefaultToolkit().getImage("/Users/bangkura/Documents/workspace/UI/image2.jpg"); 
		...
		Point_remove_buton.addActionListener(new ActionListener() {			
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(arc.selected_Point != null) {
					...
					console.setText("Delete successfully! And " + edge_no/2 + " related edges deleted");
				}
				arc.selected_Point = null;
				arc.repaint();
			}
